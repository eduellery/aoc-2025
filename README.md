...
![Tests](https://github.com/eduellery/aoc-2025/actions/workflows/aoc-2025.yml/badge.svg)

My answers for Advent of Code 2025.[^disclaimer]
...
* [Java 25 - History of Java](https://en.wikipedia.org/wiki/Java_(software_platform)#Java_versions)
...
This 2025 edition is a special, celebratory one: 10 years of AoC, 25 years since my first paid job, and Java turning 30. So it feels only fitting to use the language I’ve written the most in my life (Java) — which, coincidentally, has its latest LTS in a round-ish number, 25 (I’m fine with multiples of 5). From that version, I’ll try to incorporate as many features as possible.
